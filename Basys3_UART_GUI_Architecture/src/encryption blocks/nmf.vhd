...
ENTITY nmf IS
    ...
    PORT (
        ...
        --inputs
        word_input        :  IN STD_LOGIC_VECTOR (15 DOWNTO 0); -- 16-bit input word

        --outputs
        mixed_word_output :  OUT STD_LOGIC_VECTOR (15 DOWNTO 0) -- 16-bit transformed output
...
ARCHITECTURE Behavioral OF nmf IS
    ...
    SIGNAL Sbox_out: STD_LOGIC_VECTOR(15 DOWNTO 0);
